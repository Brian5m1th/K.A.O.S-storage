...
*LangGraph & LLM Orchestration Architecture*

> Detalha o design do proxy OpenAI-compativel, roteadores dinamicos de requisicoes e a orquestracao central de agentes.
...
## Tags
#kaos #arquitetura #langgraph #orchestrator #fastapi
...
A partir da Fase 8, o gateway propaga o `UserContext` (user_id, username, role) do Open WebUI para o AgentService. Consulte [[Propagacao de Contexto de Usuario]] para a arquitetura detalhada.
...
- [[Fase 2 - IA Local]] — Implementação do LLMService e endpoint de chat
